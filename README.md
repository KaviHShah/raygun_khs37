# This fork is to be used to investigate replacing the reduction and expansion functions in raygun to a single function that can do both and is still fully differentiable. 
